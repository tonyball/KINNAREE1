	...
	<div class="container">
		<div class="card-panel col s12">
			...
			<div class=" col s12 ">
				 ...
				 <h5><i class="fa fa-male"></i>ผู้โดยสาร ผู้ใหญ่ คนที่ 1</h5>
				 	<div class="divider"></div><br/>
				      ...
				      <div class="row">
				       ...
				       <h5><i class="fa fa-male"></i>ผู้โดยสาร ผู้ใหญ่ คนที่ 2</h5>
				 	<div class="divider"></div><br/>
				      <div class="row">
				      	<div class="col s2">
						  <label style="font-size:11px;" class="black-text"><img src="images/Name-52.png" width="16" height="16"> คำนำหน้าชื่อ</label>
				      ...
				      <div class="row ">
				     	 <h5><i class="fa fa-child"></i>เด็ก คนที่ 1</h5>
				      		<div class="divider"></div><br/>
				      	<div class="col s2">
				      		
						  <label style="font-size:10px;" class="black-text"><img src="images/Name-52.png" width="16" height="16"> คำนำหน้าชื่อ</label>
						  	<select class="browser-default">
							    <option value=""selected>Mstr.</option>
							    <option value="1">Miss.</option>
						  	</select>
						 </div>
						 <div class="col s5">
						 	<div class="input-field">
					          <input name='text'id="last_name" type="text" class="validate" onKeyPress="return KeyCode(text)" onChange="javascript:this.value=this.value.toUpperCase();">
					          <label for="last_name">ชื่อ</label>
					        </div>
						 </div>
						 <div class="col s5">
				...
				<a href="optional1.php" class="waves-effect waves-light btn green right" style="margin-top:0px;" width="100%">&nbsp&nbsp&nbsp&nbspต่อไป&nbsp&nbsp&nbsp&nbsp</a>
